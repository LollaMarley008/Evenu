<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($description)){
      $descriptionError = "Enter a description of your services";
    }

    if(empty($nameError) && empty($locationError) && empty($descriptionError)){
      require "../../authentication/php/dbconn.php";

      $setTable = $conn->prepare("INSERT INTO services(name,location,description) VALUES(:name,:location,:description)");
...
<body>
  ...
  <div class="sidebar" id="sidebar">
      ...
      <a href="#" class="active"><i class="bi bi-plus-circle me-2"></i> Add Service</a>
  ...
  <div class="content bg-white rounded ">
    ...
    <form class="" method="post">
        <!-- Service Name -->
        <div class="mb-3">
            <label for="event-name" class="form-label">Service Name</label>
            <input type="text" class="form-control" id="event-name" placeholder="Enter service name" name="name">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="location" placeholder="Enter service location" name="location">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="description" rows="4" placeholder="Enter service description" name="description"></textarea>
